...
from src.config import message_stage_3

load_dotenv()

def openAIstage3(user_last_messages):
    seller_message = "\n".join(message_stage_3)
    ...
    gpt_prompt = augmented_prompt.prompt_by_stage(user_last_messages=formated_message, stage=1)
